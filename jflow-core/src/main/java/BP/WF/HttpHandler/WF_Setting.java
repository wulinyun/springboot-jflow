...
*/
   ...
   public  String ChangeDept_Submit() throws Exception
	
    {
        ...
        WebUser.setFK_Dept(dept.getNo());//FK_Dept = dept.No;
        WebUser.setFK_DeptName(dept.getName());//FK_DeptName = dept.Name;
        WebUser.setFK_DeptNameOfFull(dept.getNameOfPath());//FK_DeptNameOfFull = dept.NameOfPath;
	...
	{
		String sql = "SELECT a.No,a.Name, NameOfPath, '0' AS  CurrentDept FROM Port_Dept A, Port_DeptEmp B WHERE A.No=B.FK_Dept AND B.FK_Emp='" + WebUser.getNo() + "'";
