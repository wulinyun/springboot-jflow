...
import com.landasoft.demo.springboot.jflow.springbootjflow.webservice.LocalWSI;
...
public class LocalWS implements LocalWSI {
	...
	public String SendWork(String flowNo, long workid, Hashtable ht, int toNodeID, String toEmps, String userNo)
			throws Exception {
		BP.WF.Dev2Interface.Port_Login(userNo);
		SendReturnObjs objs = BP.WF.Dev2Interface.Node_SendWork(flowNo, workid, ht, toNodeID, toEmps);
