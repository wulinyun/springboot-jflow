package com.landasoft.demo.springboot.jflow.springbootjflow.webservice.impl;

import javax.jws.WebService;

import BP.DA.*;
import com.landasoft.demo.springboot.jflow.springbootjflow.webservice.PortalInterfaceWS;
...
// [com.landasoft.demo.springboot.jflow.springbootjflow.WebService(Namespace = "http://tempuri.org/"), WebServiceBinding(ConformsTo
// = WsiProfiles.BasicProfile1_1), System.ComponentModel.ToolboxItem(false)]
@Deprecated
@WebService(endpointInterface="com.landasoft.demo.springboot.jflow.springbootjflow.webservice.PortalInterfaceWS",serviceName="PortalInterfaceWS")
public class PortalInterfaceWSImpl implements PortalInterfaceWS {
	...
	public final boolean SendToWeiXin(String mypk, String sender, String sendToEmpNo, String tel, String msgInfo) {
		...
		if (BP.Sys.SystemConfig.getIsEnableCCIM() && sendToEmpNo != null) {
			BP.WF.Glo.SendMessageToCCIM(sender, sendToEmpNo, msgInfo, DataType.getCurrentDataTime());
		}
		return true;
	}
	...
	public final boolean SendToCCIM(String mypk, String userNo, String msg, String sourceUserNo, String tag) {
		...
		if (BP.Sys.SystemConfig.getIsEnableCCIM() && userNo != null) {
			try{
				BP.WF.Glo.SendMessageToCCIM(BP.Web.WebUser.getNo(), userNo, msg, DataType.getCurrentDataTime());
			}catch (Exception e){
	...
	public final int CheckUserNoPassWord(String userNo, String password) {
		...
		try {
			...
			Object tempVar = DBAccess.RunSQLReturnVal(sql);
	...
	public final DataTable GetDeptsByParentNo(String parentDeptNo) {
		...
		/// #region 简单 Demo
		try {
			return DBAccess.RunSQLReturnTable("SELECT No,Name,ParentNo FROM Port_Dept WHERE ParentNo='"
	...
	public final DataTable GetEmps() {
		...
		/// #region 简单 Demo
		try {
			return DBAccess.RunSQLReturnTable(
